        ...
        <div class="min-h-screen flex bg-brand-dark" x-data="{ sidebarOpen: false }">
            ...
            <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
                ...
                <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                    ...
                    <a href="{{ route('admin.courses.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl text-brand-medium hover:bg-brand-white/10 hover:text-brand-white transition-all duration-200 group">
