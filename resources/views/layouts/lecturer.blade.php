        ...
        <div class="min-h-screen flex bg-brand-dark" x-data="{ sidebarOpen: false }">
            ...
            <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
                ...
                <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                    ...
                    <a href="{{ route('lecturer.courses') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl text-brand-medium hover:bg-brand-white/10 hover:text-brand-white transition-all duration-200 group">
                    ...
                    <a href="{{ route('lecturer.students') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl text-brand-medium hover:bg-brand-white/10 hover:text-brand-white transition-all duration-200 group">
                        <svg class="w-6 h-6 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('lecturer.profile.edit') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl {{ request()->routeIs('profile.edit') ? 'bg-brand-medium text-brand-dark shadow-lg' : 'text-brand-medium hover:bg-brand-white/10 hover:text-brand-white' }} transition-all duration-200 group">
                        <svg class="w-6 h-6 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
